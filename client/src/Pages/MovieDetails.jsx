...
import timeFormat from '../lib/timeFormet'
...
const MovieDetails = () => {
  ...
  return show ?(
    <div className='px--6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <p className='text-lg font-medium mt-20'>Yiur Favourite Cast</p>
      <div className='overflow-x-auto no-scrollbar mt-8 mb-4'>
      ...
      <div className='flex felx-weap max-sm:justify-center gap-8'>
          {dummyShowsData.slice(0,4).map((movie,index)=>(
            <MomviCard key={index} movie={movie}/>
          ))}
      </div>
